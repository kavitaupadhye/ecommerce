...
public class Code_For_JavaScriptExecutor_9 {
	...
	public void Code_For_JavaScriptExecutor_Test() throws Exception {
		...
		JavascriptExecutor js=(JavascriptExecutor)w; // downcasting 
		...
		Thread.sleep(2000);
		w.findElement(By.xpath("//*[@id=\"basicBootstrapForm\"]/div[7]/div/multi-select/div[2]/ul/li[8]")).click();
		Thread.sleep(2000);
